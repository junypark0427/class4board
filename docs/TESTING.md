...
- PGlite 실제 PostgreSQL 엔진으로 스키마/RLS 보안 테스트를 실행합니다. 공개 승인 전 차단, 승인 후 안전한 사본 조회, 숨김·승인 취소도 포함합니다.
...
운영 Supabase와 Netlify 연결은 별도로 완료되었습니다. 스키마 변경 후에는 002 마이그레이션 적용과 새 프로덕션 배포를 확인하세요.
